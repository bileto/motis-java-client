...
public class Place {
  ...
  public static final String JSON_PROPERTY_STOP_CODE = "stopCode";
  @jakarta.annotation.Nullable
  ...
  public Place level(@jakarta.annotation.Nullable BigDecimal level) {
  ...
  public Place stopCode(@jakarta.annotation.Nullable String stopCode) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_STOP_CODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_STOP_CODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStopCode(@jakarta.annotation.Nullable String stopCode) {
    this.stopCode = stopCode;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, stopId, parentId, importance, lat, lon, level, tz, arrival, departure, scheduledArrival, scheduledDeparture, scheduledTrack, track, stopCode, description, vertexType, pickupType, dropoffType, cancelled, alerts, flex, flexId, flexStartPickupDropOffWindow, flexEndPickupDropOffWindow, modes);
  }
