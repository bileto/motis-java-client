...
/**
 * Gets or Sets FareTransferRule
 */
public enum FareTransferRule {
  ...
  @JsonCreator
  public static FareTransferRule fromValue(String value) {
    for (FareTransferRule b : FareTransferRule.values()) {
