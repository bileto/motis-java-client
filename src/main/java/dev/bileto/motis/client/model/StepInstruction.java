...
@JsonPropertyOrder({
  ...
  StepInstruction.JSON_PROPERTY_FROM_OSM_NODE,
  StepInstruction.JSON_PROPERTY_TO_OSM_NODE,
...
public class StepInstruction {
  ...
  public static final String JSON_PROPERTY_FROM_OSM_NODE = "fromOsmNode";
  @jakarta.annotation.Nullable
  private Integer fromOsmNode;

  public static final String JSON_PROPERTY_TO_OSM_NODE = "toOsmNode";
  @jakarta.annotation.Nullable
  private Integer toOsmNode;
  ...
  public StepInstruction fromOsmNode(@jakarta.annotation.Nullable Integer fromOsmNode) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FROM_OSM_NODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getFromOsmNode() {
    return fromOsmNode;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FROM_OSM_NODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFromOsmNode(@jakarta.annotation.Nullable Integer fromOsmNode) {
    this.fromOsmNode = fromOsmNode;
  }

  public StepInstruction toOsmNode(@jakarta.annotation.Nullable Integer toOsmNode) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TO_OSM_NODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getToOsmNode() {
    return toOsmNode;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TO_OSM_NODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setToOsmNode(@jakarta.annotation.Nullable Integer toOsmNode) {
    this.toOsmNode = toOsmNode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.relativeDirection, stepInstruction.relativeDirection) &&
        ...
        Objects.equals(this.fromOsmNode, stepInstruction.fromOsmNode) &&
        Objects.equals(this.toOsmNode, stepInstruction.toOsmNode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(relativeDirection, distance, fromLevel, toLevel, osmWay, fromOsmNode, toOsmNode, polyline, streetName, exit, stayOn, area, toll, accessRestriction, elevationUp, elevationDown);
  }
  ...
  public String toString() {
    ...
    sb.append("    fromOsmNode: ").append(toIndentedString(fromOsmNode)).append("\n");
    sb.append("    toOsmNode: ").append(toIndentedString(toOsmNode)).append("\n");
