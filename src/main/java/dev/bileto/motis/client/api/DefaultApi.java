...
public class DefaultApi {
    ...
    private ResponseSpec healthRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/api/v1/health", HttpMethod.GET, pathParams, localVarQueryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
